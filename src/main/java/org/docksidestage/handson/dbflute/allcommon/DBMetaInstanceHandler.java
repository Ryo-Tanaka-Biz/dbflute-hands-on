...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("member", "org.docksidestage.handson.dbflute.bsentity.dbmeta.MemberDbm");
        tmpMap.put("member_address", "org.docksidestage.handson.dbflute.bsentity.dbmeta.MemberAddressDbm");
        tmpMap.put("member_following", "org.docksidestage.handson.dbflute.bsentity.dbmeta.MemberFollowingDbm");
        tmpMap.put("member_login", "org.docksidestage.handson.dbflute.bsentity.dbmeta.MemberLoginDbm");
        tmpMap.put("member_security", "org.docksidestage.handson.dbflute.bsentity.dbmeta.MemberSecurityDbm");
        tmpMap.put("member_service", "org.docksidestage.handson.dbflute.bsentity.dbmeta.MemberServiceDbm");
        tmpMap.put("member_status", "org.docksidestage.handson.dbflute.bsentity.dbmeta.MemberStatusDbm");
        tmpMap.put("member_withdrawal", "org.docksidestage.handson.dbflute.bsentity.dbmeta.MemberWithdrawalDbm");
        tmpMap.put("product", "org.docksidestage.handson.dbflute.bsentity.dbmeta.ProductDbm");
        tmpMap.put("product_category", "org.docksidestage.handson.dbflute.bsentity.dbmeta.ProductCategoryDbm");
        tmpMap.put("product_status", "org.docksidestage.handson.dbflute.bsentity.dbmeta.ProductStatusDbm");
        tmpMap.put("purchase", "org.docksidestage.handson.dbflute.bsentity.dbmeta.PurchaseDbm");
        tmpMap.put("purchase_payment", "org.docksidestage.handson.dbflute.bsentity.dbmeta.PurchasePaymentDbm");
        tmpMap.put("region", "org.docksidestage.handson.dbflute.bsentity.dbmeta.RegionDbm");
        tmpMap.put("service_rank", "org.docksidestage.handson.dbflute.bsentity.dbmeta.ServiceRankDbm");
        tmpMap.put("withdrawal_reason", "org.docksidestage.handson.dbflute.bsentity.dbmeta.WithdrawalReasonDbm");
